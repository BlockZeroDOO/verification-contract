...
echo "[deploy-retail-jungle4] WARNING: verifretail is a deprecated compatibility path."
echo "[deploy-retail-jungle4] Prefer deploying verif + verifretpay for new environments."
