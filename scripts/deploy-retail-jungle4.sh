...
echo "[deploy-retail-jungle4] WARNING: verifretail is a legacy contract and not part of the supported architecture."
echo "[deploy-retail-jungle4] Supported retail model: verif + verifretpay."
