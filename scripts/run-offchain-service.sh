...
rpc_url="${WATCHER_RPC_URLS:-${RPC_URL:-https://history.denotary.io}}"
state_backend="${FINALITY_STATE_BACKEND:-sqlite}"
...
ingress_watcher_rpc_url="${INGRESS_WATCHER_RPC_URLS:-${INGRESS_WATCHER_RPC_URL:-${WATCHER_RPC_URLS:-${RPC_URL:-https://history.denotary.io}}}}"
