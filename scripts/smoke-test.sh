...
export OWNER_ACCOUNT="${OWNER_ACCOUNT:?Set OWNER_ACCOUNT to the verification governance account.}"
...
printf '[smoke-test] Legacy proof-payment smoke path is disabled; delegating to smoke-test-onchain.sh\n'
